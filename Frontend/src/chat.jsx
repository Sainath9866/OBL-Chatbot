...
export default function ChatInterface({ setShowChat }) {
  ...
  return (
    <div className="h-screen bg-gray-100 flex items-center justify-center p-4">
      <div className="w-full max-w-[300px] md:max-w-[350px] lg:max-w-[400px] h-screen md:h-screen bg-white rounded-lg shadow-lg flex flex-col">
        {/* Header */}
        <div className="bg-green-600 p-3 md:p-4 rounded-t-lg flex items-center justify-between shrink-0">
          <div className="flex items-center gap-2 md:gap-2">
            <div className="w-7 h-7 md:w-8 md:h-8 bg-white rounded-full flex items-center justify-center shrink-0">
              <img src="https://www.kenyt.ai/static/Organizations/Orient%20Bells-6580399/OrientBell_Tiles/chatbot-icon.png" alt="Orient Bell Logo" className="rounded-full" />
            </div>
